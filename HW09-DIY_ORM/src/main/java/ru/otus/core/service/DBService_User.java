...
public class DBService_User implements DBService<User>{
    private static Logger logger = LoggerFactory.getLogger(DBService_User.class);

    private final Dao<User> dao;

    public DBService_User(Dao<User> dao) {
        this.dao = dao;
    }
